 ...
 */
exports.prettyprint = function( obj, depth, indent ){
    ...
    return ( fn[ type ] || fn.default )( obj, depth, indent );
};
 ...
 */
exports.format = {
    '[object Array]' : function( obj, depth, indent ){
	var r = [], contains_multiline = false, v, multiline = /[\r\n]/;
	for( var i = 0, l = obj.length ; i < l ; ++i ){
	    r[i] = exports.prettyprint( obj[i], depth - 1, indent + 1 );
    ...
    '[object Object]': function( obj, depth, indent ){
	var r = [], contains_multiline = false, v, multiline = /[\r\n]/;
	for( var prop in obj ){
